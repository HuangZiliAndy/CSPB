...
train_dir=/export/c02/hzili1/datasets/s3prl_csp/downstream/diar_ami/${data}/train_filter
dev_dir=/export/c02/hzili1/datasets/s3prl_csp/downstream/diar_ami/${data}/dev_filter
